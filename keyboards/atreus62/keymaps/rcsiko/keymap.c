...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = {
        ...
        { KC_LSFT  ,KC_Z     ,KC_X     ,KC_C     ,KC_V     ,KC_B          ,LT_SYM_SPC         ,KC_N           ,KC_M    ,KC_COMM ,KC_DOT  ,KC_SLSH   ,KC_RSFT },
        { TT(NUM)  ,KC_NO    ,KC_NO    ,KC_NO    ,KC_LALT  ,GUI_T(KC_SPC) ,LT_SYM_SPC         ,GUI_T(KC_ENT)  ,MO(NAV) ,KC_RALT ,KC_NO   ,KC_RCTRL  ,LCAG(KC_NO) }
    ...
    [SYM] = {
        ...
        { _____    ,_____     ,_____     ,_____    ,_____    ,M(0)         ,_NO_       ,_____     ,_____     ,_____        ,_____       ,_____        ,_____ },
