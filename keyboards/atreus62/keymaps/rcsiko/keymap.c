...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = {
        ...
        { MO(NUM)        ,KC_NO    ,KC_NO    ,KC_NO    ,KC_LALT  ,KC_LGUI       ,LT(SYM, KC_SPC)    ,GUI_T(KC_ENT)  ,KC_RALT ,KC_RCTRL,KC_NO   ,KC_NO             ,KC_NO }
    ...
    [SYM] = {
      ...
      { _____   ,KC_F1   ,KC_F2   ,KC_F3   ,KC_F4   ,KC_F5    ,_NO_    ,KC_F6   ,KC_F7   ,KC_F8   ,KC_F9   ,KC_F10  ,_____ },
      { _____   ,KC_F11  ,KC_F12  ,_____   ,_____   ,KC_LBRC  ,_NO_    ,KC_RBRC ,_____   ,_____   ,_____   ,_____   ,_____ },
